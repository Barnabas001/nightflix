...
const SponsorLogo: React.FC<{
  ...
  const sizeClass =
    size === "sm" ? "h-8 px-2" : size === "lg" ? "h-16 px-4" : "h-12 px-3";
    ...
    eridan: (
      <div className={`flex items-center gap-1.5 ${sizeClass}`}>
        <svg viewBox="0 0 20 20" className="h-5 w-5" fill="none">
          ...
          <path
            d="M6 10 C6 6 14 6 14 10 C14 14 6 14 6 10Z"
            fill="#e91e8c"
            opacity="0.4"
          />
      ...
      <div className={`flex items-center ${sizeClass}`}>
        ...
        >
          <div>
            <div
              className="text-white font-bold"
              style={{ fontSize: "0.75rem", fontFamily: "Georgia, serif" }}
            >
              Johnvents
            </div>
            <div
    ...
    rokswood: (
      <div className={`flex items-center gap-1.5 ${sizeClass}`}>
        <svg viewBox="0 0 20 30" className="h-8 w-5" fill="none">
          <path
            d="M10 2 L10 28 M6 8 L10 5 L14 8 M4 14 L10 10 L16 14 M6 20 L10 16 L14 20"
            stroke="#3d2b1a"
            strokeWidth="1.5"
            strokeLinecap="round"
          />
        ...
        <div>
          ...
          <div
            className="text-gray-400 leading-none italic"
    ...
    airtel: (
      <div className={`flex items-center gap-1 ${sizeClass}`}>
        ...
        <span
          ...
          style={{ fontSize: size === "lg" ? "1rem" : "0.85rem" }}
        >
          airtel
        </span>
      </div>
    ...
    orijin: (
      <div className={`flex items-center ${sizeClass}`}>
        <div
          ...
          style={{ background: "radial-gradient(circle, #1a4a1a, #0a2a0a)" }}
        >
          <span
      ...
      <div className={`flex flex-col items-center ${sizeClass}`}>
        <div className="border-2 border-red-600 rounded-full px-2 py-0.5">
          <span
            ...
            style={{ fontSize: "0.8rem", fontFamily: "Georgia, serif" }}
          >
            Gala
          </span>
        </div>
        <span
          ...
          style={{ fontSize: "0.9rem", color: "#f5a623" }}
        >
          chinchin
        </span>
        <span className="text-gray-500 italic" style={{ fontSize: "0.4rem" }}>
          Delicious, Crunchy, & Yummy
        </span>
      </div>
    ),
    gamehouse: (
      <div className={`flex items-center ${sizeClass}`}>
        <div
          className="rounded-full w-12 h-12 flex items-center justify-center"
          style={{ background: "radial-gradient(circle, #1a0a3a, #0a0520)" }}
        >
          <div className="text-center">
            <svg viewBox="0 0 16 14" className="h-4 w-4 mx-auto" fill="none">
              ...
              />
              <path
                d="M5 8H7M6 7V9M10 8H11M9.5 8H10.5"
                stroke="#a855f7"
                strokeWidth="1"
                strokeLinecap="round"
              />
            ...
            <div
              className="text-purple-400 leading-none"
              style={{ fontSize: "0.35rem", letterSpacing: "0.05em" }}
            >
              GAME HOUSE
            </div>
          </div>
      ...
      <div className={`flex items-center ${sizeClass}`}>
        <div className="bg-black w-12 h-12 flex items-center justify-center">
          <span
            ...
            style={{ fontSize: "0.4rem", textAlign: "center", lineHeight: 1.3 }}
          >
            MR VIRGIN
            <br />
            SHOT IT
...
const SponsorBar: React.FC = () => {
  ...
  return (
    <div
      className="bg-white border-b border-gray-100 overflow-hidden relative"
      style={{ height: "56px" }}
    >
      <div
        className="flex items-center gap-1 absolute top-0 left-0 h-full"
        style={{
          whiteSpace: "nowrap",
      ...
      >
        <div className="flex items-center gap-2 pr-4 border-r border-gray-200 h-full">
          ...
          <span className="text-xs font-semibold text-gray-500 tracking-widest uppercase whitespace-nowrap">
            Official Sponsors
          </span>
        </div>
        {items.map((s, i) => (
